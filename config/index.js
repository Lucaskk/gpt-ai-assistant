...
const config = Object.freeze({
  ...
  STOCK_ANALYSIS_BASE_URL: env.STOCK_ANALYSIS_BASE_URL || null,
  STOCK_REQUEST_GITHUB_TOKEN: env.STOCK_REQUEST_GITHUB_TOKEN || null,
  STOCK_REQUEST_REPOSITORY: env.STOCK_REQUEST_REPOSITORY || 'Lucaskk/daily-news',
  STOCK_REQUEST_BRANCH: env.STOCK_REQUEST_BRANCH || 'main',
  STOCK_REQUEST_QUEUE_PATH: env.STOCK_REQUEST_QUEUE_PATH || 'wiki/stocks/requests',
